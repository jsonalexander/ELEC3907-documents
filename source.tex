...
\newpage
		...
		\subsection{Preliminary Specifications and Requirements}
			...
			\subsubsection{The outputs}
				...
				The audio output will consist of two small speakers.
				These speakers were available in the lab, so they resulted in no additional cost.

			\subsubsection{The user inputs}

				The user inputs---removable controllers---will each consist of a joystick fitted into a block that can be attached to the console via interlocking rails.
		...
		\subsection{Design Approaches}
			...
			\subsubsection{The divider}
				...
				\begin{enumerate}
					\item Testing variously sized dividers made of a temporary material like cardboard to determine the ideal dimensions.
					...
					\item Constructing the divider with plywood
					\item Adding freestanding supports that hold the divider upright
				\end{enumerate}
			...
			\subsection{The software}
				...
				\noindent If there are problems with our working software implementation, it will likely be due to how memory is allocated.
			...
			\subsection{Integration}
				...
				One of the last steps in the first iteration of the design process will be to ensure that the microcontrollers control the physical hardware as intended.
